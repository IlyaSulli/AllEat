...
class _RestaurantListState extends State<RestaurantList> {
  ...
  Future<List> getRestaurants() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (data["error"]) {
          List<Map<String, dynamic>> error = [
            {"error": true, "message": data["message"], "restaurants": "[]"}
          ];
          return error;
        } else {
        ...
        List error = [
          {
            "error": true,
            "message": "Error ${res.statusCode}: Please try again.",
            "restaurants": "[]"
          }
        ];
        print("error here 2");
      ...
      List error = [
        {"error": true, "message": "$e", "restaurants": "[]"}
      ];
      print("error here 3");
      return error;
    }
  ...
  Future<List> getDistance(restaurantdata) {
    ...
    return FutureBuilder<List>(
      ...
      builder: ((context, snapshot) {
        ...
        if (!snapshot.hasData) {
          ...
          //If recieved data
          //try {
          //if (restaurantsdata[0] != false) {
          //  return Container(
          //    child: Text(restaurantsdata[0]["message"]),
          //  );
          //} else {
